...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = [UIColor orangeColor].CGColor;
    self.ratioView.layer.borderWidth = 2.0f;
//    self.ratioView.layer.cornerRadius = self.cropFrame.size.width/2;
//    [self.ratioView.layer setMasksToBounds:YES];
...
//    int radius = 320 ;
//    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, self.ratioView.bounds.size.width, self.ratioView.bounds.size.height) cornerRadius:0];
//    UIBezierPath *circlePath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 100, 2.0*radius, 2.0*radius) cornerRadius:radius];
...
//    maskLayer.opacity = 0.5;
    ...
    /*
    maskLayer.path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, 2.0*100, 2.0*100)
                                             cornerRadius:100].CGPath;
    // Center the shape in self.view
    maskLayer.position = CGPointMake(CGRectGetMidX(self.view.frame)-100,
